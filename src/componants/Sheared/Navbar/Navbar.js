        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <div className="d-flex ">
                    <Link style={{ color: 'black' }} to="/cart"><FontAwesomeIcon style={{ fontSize: "35px" }} icon={faShoppingBag} /></Link> <p style={{ margin: '2px', backgroundColor: "black", padding: "5px 11px", borderRadius: "50%", color: "white" }}>{cart.length}</p>
                </div>
            </div>
        </nav>
    );
